...
inline cl_memclCreateBuffer(cl_context
p0,
cl_mem_flags p1, size_t
p2,
void *p3,
        cl_int
*p4) {
...
p0,
cl_device_id p1, cl_command_queue_properties
p2,
cl_int *p3
) {
return
...
p0,
cl_mem_flags p1,
const cl_image_format *p2, size_t
p3,
size_t p4,
        size_t
p5,
...
inline cl_intclCreateKernelsInProgram(cl_program
p0,
cl_uint p1, cl_kernel
*p2,
cl_uint *p3
) {
return
...
inline cl_memclCreateSubBuffer(cl_mem
p0,
cl_mem_flags p1, cl_buffer_create_type
p2,
const void *p3,
        cl_int
*p4) {
...
inline cl_intclCreateSubDevices(cl_device_id
p0,
const cl_device_partition_property *p1, cl_uint
p2,
cl_device_id *p3, cl_uint
*p4) {
return
...
inline cl_event clCreateUserEvent(cl_context
p0,
cl_int *p1
) {
return
...
inline cl_intclEnqueueBarrierWithWaitList(cl_command_queue
p0,
cl_uint p1,
const cl_event *p2,
        cl_event
...
inline cl_intclEnqueueCopyBufferRect(cl_command_queue
p0,
cl_mem p1, cl_mem
p2,
const size_t *p3,
const size_t *p4,
const size_t *p5, size_t
p6,
size_t p7,
        size_t
p8,
...
inline cl_intclEnqueueCopyImageToBuffer(cl_command_queue
p0,
cl_mem p1, cl_mem
p2,
const size_t *p3,
const size_t *p4, size_t
p5,
cl_uint p6,
const cl_event *p7,
        cl_event
...
inline cl_intclEnqueueFillImage(cl_command_queue
p0,
cl_mem p1,
const void *p2,
const size_t *p3,
const size_t *p4, cl_uint
p5,
const cl_event *p6, cl_event
*p7) {
return
...
inline cl_int clEnqueueMarker(cl_command_queue
p0,
cl_event *p1
) {
return
...
inline cl_intclEnqueueMarkerWithWaitList(cl_command_queue
p0,
cl_uint p1,
const cl_event *p2,
        cl_event
...
inline cl_intclEnqueueMigrateMemObjects(cl_command_queue
p0,
cl_uint p1,
const cl_mem *p2,
...
inline cl_intclEnqueueNDRangeKernel(cl_command_queue
p0,
cl_kernel p1, cl_uint
p2,
const size_t *p3,
const size_t *p4,
const size_t *p5, cl_uint
...
inline cl_int clEnqueueNativeKernel(cl_command_queue
p0,
void (CL_CALLBACK
...
inline cl_intclEnqueueReadBufferRect(cl_command_queue
p0,
cl_mem p1, cl_bool
p2,
const size_t *p3,
...
inline cl_intclEnqueueTask(cl_command_queue
p0,
cl_kernel p1, cl_uint
p2,
const cl_event *p3,
...
inline cl_intclEnqueueWaitForEvents(cl_command_queue
p0,
cl_uint p1,
const cl_event *p2
) {
...
inline cl_intclEnqueueWriteBuffer(cl_command_queue
p0,
cl_mem p1, cl_bool
p2,
size_t p3, size_t
p4,
const void *p5, cl_uint
p6,
const cl_event *p7, cl_event
*p8) {
return
...
inline cl_intclEnqueueWriteBufferRect(cl_command_queue
p0,
cl_mem p1, cl_bool
p2,
const size_t *p3,
...
inline cl_int clFlush(cl_command_queue
p0) {
return
clFlush_pfn(p0);
}
...
p0,
cl_command_queue_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
inline cl_intclGetContextInfo(cl_context
p0,
cl_context_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
inline cl_intclGetDeviceIDs(cl_platform_id
p0,
cl_device_type p1, cl_uint
p2,
cl_device_id *p3,
        cl_uint
*p4) {
...
inline cl_intclGetDeviceInfo(cl_device_id
p0,
cl_device_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
inline cl_intclGetImageInfo(cl_mem
p0,
cl_image_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
inline cl_intclGetKernelInfo(cl_kernel
p0,
cl_kernel_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
p0,
cl_device_id p1, cl_kernel_work_group_info
p2,
size_t p3,
void *p4, size_t
*p5) {
...
inline cl_intclGetMemObjectInfo(cl_mem
p0,
cl_mem_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
inline cl_intclGetPlatformInfo(cl_platform_id
p0,
cl_platform_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
p0,
cl_device_id p1, cl_program_build_info
p2,
size_t p3,
void *p4,
        size_t
...
inline cl_intclGetProgramInfo(cl_program
p0,
cl_program_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
inline cl_intclGetSamplerInfo(cl_sampler
p0,
cl_sampler_info p1, size_t
p2,
void *p3,
        size_t
*p4) {
...
p0,
cl_mem_flags p1, cl_mem_object_type
p2,
cl_uint p3,
        cl_image_format
*p4,
...
inline cl_int clReleaseDevice(cl_device_id
p0) {
return
...
inline cl_int clReleaseSampler(cl_sampler
p0) {
return
...
inline cl_int clRetainCommandQueue(cl_command_queue
p0) {
return
...
inline cl_int clRetainContext(cl_context
p0) {
return
...
inline cl_int clRetainDevice(cl_device_id
p0) {
return
...
inline cl_int clRetainKernel(cl_kernel
p0) {
return
...
inline cl_int clRetainMemObject(cl_mem
p0) {
return
...
inline cl_int clRetainProgram(cl_program
p0) {
return
...
inline cl_int clRetainSampler(cl_sampler
p0) {
return
...
inline cl_intclSetKernelArg(cl_kernel
p0,
cl_uint p1, size_t
p2,
const void *p3
...
inline cl_int clSetMemObjectDestructorCallback(cl_mem
p0,
void (CL_CALLBACK
